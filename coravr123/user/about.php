...
<head>
    ...
    <meta property="og:title" content="About — CoraVergel Resort">
    <meta property="og:description" content="Learn more about CoraVergel Resort, a family-friendly getaway in Tigbauan, Iloilo offering rooms, cottages, and pools.">
    <meta property="og:image" content="https://coravergelresort.com/assets/images/1.jpg">
    <meta property="og:url" content="https://coravergelresort.com/pages/about.php">
...
<button class="drawer-close-x" id="drawerCloseBtn" onclick="closeDrawer()" aria-label="Close menu">
    ...
    <!-- ══════════ OUR STORY ══════════ -->
<section class="about-section" style="margin-top:75px;">
