    ...
    <div class="rshowcase-panel active" id="rsp-0">
        <div class="rshowcase-cards" id="rsc-0">
            <div class="rshowcase-card active">
                <img class="rsc-bg-img" src="../assets/images/rooms/duplex-room.jpg" alt="Duplex Room">
...
<aside class="cv-policy-ack" id="cvPolicyAck" aria-label="Resort policy acknowledgment">
    <div class="cv-policy-ack-head">
        <div class="cv-policy-ack-icon"><i class="fa-solid fa-shield-halved"></i></div>
        <div>
...
<div class="cv-rules-modal" id="cvRulesModal" aria-hidden="true">
    <div class="cv-rules-box" role="dialog" aria-modal="true" aria-labelledby="cvRulesTitle">
        ...
        <div class="cv-rules-footer">
            <div style="width:100%;">
                <label class="cv-rules-agreement" for="cvRulesAgree">
                    <input type="checkbox" id="cvRulesAgree">
                    <span>I have read and understood the <strong>Resort Rules &amp; Policies</strong>.</span>
                </label>
                <div class="cv-rules-footer-actions">
                    <div class="cv-rules-footer-note"><i class="fa-solid fa-shield-halved"></i> Please review all resort rules before making your reservation.</div>
                    <button type="button" class="cv-rules-ok-btn" id="cvRulesOk" disabled>I UNDERSTAND</button>
                </div>
            </div>
        </div>
    </div>
